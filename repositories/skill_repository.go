...
type SkillRepository interface {
	GetAll() *models.Skill
	GetItems() []models.Items
	GetLanguages() []models.Languages
	GetTags() []string
}
...
func (s *skillRepository) GetAll() *models.Skill {
	return &models.Skill{
		Items:     s.GetItems(),
...
func (s *skillRepository) GetItems() []models.Items {
	return []models.Items{
		{
			Title: "Front-End",
			Stars: 10,
...
func (s *skillRepository) GetLanguages() []models.Languages {
...
func (s *skillRepository) GetTags() []string {
	return []string{
		"FullStack",
		"Software",
		"Developer",
